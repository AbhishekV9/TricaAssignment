...
function Navbar(){
    return(
        <div className="nav">
            ...
            <div className="nav-right"><img src="https://cdn.pixabay.com/photo/2020/07/14/13/07/icon-5404125_1280.png" alt="userlogo"/><p>&nbsp;Hellow, Shankar&nbsp;&nbsp;</p> <i class="fas fa-angle-down"></i></div>
        </div>
